...
export const DATA = {
  name: 'Tuan Nguyen',
  initials: 'tuanna',
  url: 'https://tuannguyen.click',
  location: 'Vinh Phuc, Viet Nam',
  locationLink:
    'https://www.google.com/maps/place/V%C4%A9nh+Ph%C3%BAc,+Vietnam/@21.3642126,105.3928821,11z/data=!3m1!4b1!4m6!3m5!1s0x3134e54d82ea2dbb:0xc0d08e3fe11b105f!8m2!3d21.3608805!4d105.5474373!16zL20vMDdtMWtk?entry=ttu&g_ep=EgoyMDI1MDIwNS4xIKXMDSoASAFQAw%3D%3D',
  ...
  contact: {
    email: 'tuanna.mailbox@gmail.com',
    tel: '+868332326',
    social: {
      GitHub: {
        name: 'GitHub',
        url: 'https://github.com/tuaanna',
        icon: Icons.github,
        navbar: true,
      },
      LinkedIn: {
        name: 'LinkedIn',
        url: 'https://www.linkedin.com/in/tuaanna/',
        icon: Icons.linkedin,
        navbar: true,
      },
      Facebook: {
        name: 'X',
        url: 'https://www.facebook.com/tuaan.naa',
        icon: Icons.facebook,
        navbar: true,
      },
      X: {
        name: 'X',
        url: 'https://x.com/_tuaan_na',
        icon: Icons.x,
        navbar: true,
      },
      // Youtube: {
